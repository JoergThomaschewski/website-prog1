...
# 6. Ausgabe einer Berechnung mit gerundeten Nachkommastellen
ergebnis = 10 / 3
...
# 7. Python-Besonderheit multiplizieren im print (bitte nicht verwenden)
anzahl = 5
print(anzahl * "Miau ")
