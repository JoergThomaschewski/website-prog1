...
Folgenden Sourcecode wollen wir nun verstehen. Wir beginnen mit dem einfachen Sourcecode aus dem Programm bei der die interne LED angeschaltet wurde. Sie können den Sourcecode in Thonny einfügen und laufen lassen. Die "restliche Schaltung" kann so bleiben und wird nicht genutzt.
...
| Objekt     | Instanzen von Klassen oder andere Objekte     | led = Pin()             |
